...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    /** This fork's ActionBarLayout paints its own navigation bar strip through the container. */
    ...
    /** Kept for DialogsActivity, which only wants to gate the edge swipe per tab. */
    public void setAllowDrawerSwipe(boolean allow) {
        setAllowOpenDrawerBySwipe(allow);
    }
